...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer><div className="shell"><span>Pharma Shift · 2026 Q3 baseline</span><span>{t.footer}</span></div></footer>
    </main>
  );
}
